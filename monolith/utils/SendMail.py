...
"""
def sendReservationConfirm(toEmail, toName, dateReservation, restaurantName, numberSeat):
...
"""
def sendReservationNotification(toEmail, toName, restaurantName, customerName, dateReservation, tableNumber, numberSeat):
    subject = 'Reservation notification'
    body = 'Hi {toName} from {restaurantName},<br>' \
...
def sendmailTest(subject, body, recipient):
    ...
    msg = Message(recipients=[recipient], sender='greyteam2020@gmail.com', html=body, subject=subject)
    mail.send(msg)
    return 0