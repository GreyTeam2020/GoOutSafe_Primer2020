...
class RestaurantForm(FlaskForm):
    ...
    cuisine = f.SelectMultipleField("Cuisine Type", choices=[('Italian food', 'Italian food'), (
        'Chinese food', 'Chinese food'), ('Indian Food', 'Indian Food'), ('Japanese Food', 'Japanese Food'), 
        ('Other', 'Other')], validators=[DataRequired()])
    open_days = f.SelectMultipleField("Opening days", 
    ...
    display = ["name", "phone", "lat", "lon", "n_tables", "cuisine", "open_days", 
        "open_lunch", "close_lunch", "open_dinner", "close_dinner", "covid_m"]
